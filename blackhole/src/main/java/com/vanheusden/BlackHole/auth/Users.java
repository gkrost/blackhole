...
public class Users {
	...
	protected Users(String file) throws IOException, NoSuchAlgorithmException,
			VHException {
		...
		if (newFile) {
			...
			Log.log(LogLevel.LOG_WARN,
					"No user database exists, creating new one with default user root/root");
		}
	}

	public static Users getInstance(String file) throws IOException,
			NoSuchAlgorithmException, VHException {
		if (instance == null)
	...
	public boolean changePassword(String username, String oldPassword,
			String newPassword) throws IOException, VHException {
		username = username.toLowerCase();
