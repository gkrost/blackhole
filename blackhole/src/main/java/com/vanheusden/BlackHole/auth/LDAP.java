...
public class LDAP {
	...
	public static boolean authenticateUser(String baseDN, String username,
			String password, String ldapURL) {
		...
		try {
			...
			Log.log(LogLevel.LOG_INFO, "Authentication for user " + username
					+ " succeeded");
			return true;
		} catch (AuthenticationException ex) {
			Log.log(LogLevel.LOG_WARN, "Authentication for user " + username
					+ " FAILED");
