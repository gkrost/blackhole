...
public class WritecacheParameters {
	...
	public WritecacheParameters(int forceFlushThreshold,
			int getTriggerFlushThreshhold,
			boolean sortWriteBackListBeforeWrite,
			int delayedWriteFlushInterval, int minFlushN,
			boolean readCacheDirtyBlocks) {
	...
	public String toString() {
		return "" + forceFlushThreshold + " " + getTriggerFlushThreshhold + " "
				+ sortWriteBackListBeforeWrite + " "
				+ delayedWriteFlushInterval + " " + minFlushN + " "
				+ readCacheDirtyBlocks;
	}
