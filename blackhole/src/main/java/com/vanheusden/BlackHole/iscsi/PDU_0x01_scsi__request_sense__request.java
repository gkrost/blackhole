...
public class PDU_0x01_scsi__request_sense__request extends
		PDU_0x01_scsi_request {
	public PDU_0x01_scsi__request_sense__request(byte[] b, byte[] d) {
		bytes = b;
		data = d;
	}

	public PDU_0x01_scsi__request_sense__request(int sn, int esn) {
		setBit(0, 6, true); // 1
